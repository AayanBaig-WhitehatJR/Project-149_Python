# -*- coding: utf-8 -*-
"""
Created on Mon Nov  8 11:07:37 2021
...
import random
root=Tk()
root.title("Random Word Generator (A - Z. 5 LETTERS)")
root.geometry("400x400")
root.config(bg = "cyan4")
#completed basic tkinter code ^^^^^^^
...
callGenerator = Button(root, text="Generate Random Letters", bg="gray76", font="stgotic", command=generatorFunc)
